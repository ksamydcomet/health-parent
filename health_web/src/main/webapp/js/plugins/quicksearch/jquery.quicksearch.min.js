!function (a, b) {
    a.fn.quicksearch = function (c, d) {
        ...
        return this.go = function () {
            for (var a = 0, b = 0, c = !0, d = k.prepareQuery(i), e = 0 === i.replace(" ", "").length, a = 0, h = g.length; h > a; a++)
                e || k.testQuery(d, f[a], g[a]) ? (k.show.apply(g[a]), c = !1, b++) : k.hide.apply(g[a]);
            return c ? this.results(!1) : (this.results(!0), this.stripe()), this.matchedResultsCount = b, this.loader(!1), k.onAfter(), this
