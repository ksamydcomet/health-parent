    ...
    $.fn.toggles = function (d, id, val) {
        function p(e, b, f, c) {
            ...
            if (c !== r) {
                ...
                if (r === true) {
                    e.find(".toggle-value").val(1);
                } else {
                    e.find(".toggle-value").val(0);
                }
                if (!k) {
                    var l = r ? 0 : -b + f;
                    d.css("margin-left", l);
        ...
        return this.each(function () {
            ...
            a.on && p(c, f, b);
            if (a.click && (!a.clicker || !a.clicker.has(e).length))
                e.on("click", function (b) {
                    (b.target !== h[0] || !a.drag) && c.trigger("toggle", c.hasClass("active"))
                });
            if (a.clicker)
                a.clicker.on("click", function (b) {
                    (b.target !== h[0] || !a.drag) && c.trigger("toggle", c.hasClass("active"))
                });
            if (a.drag && !k) {
                var g, u = (f - b) / 4,
