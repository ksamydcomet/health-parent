...
!function (a) {
    var b = function (b, c, d) {
        ...
        if (this.parentEl = e && c.parentEl && a(c.parentEl) || a(this.parentEl), this.container = a(g).appendTo(this.parentEl), e) {
            if ("string" == typeof c.format && (this.format = c.format), "string" == typeof c.separator && (this.separator = c.separator), "string" == typeof c.startDate && (this.startDate = moment(c.startDate, this.format)), "string" == typeof c.endDate && (this.endDate = moment(c.endDate, this.format)), "string" == typeof c.minDate && (this.minDate = moment(c.minDate, this.format)), "string" == typeof c.maxDate && (this.maxDate = moment(c.maxDate, this.format)), "object" == typeof c.startDate && (this.startDate = moment(c.startDate)), "object" == typeof c.endDate && (this.endDate = moment(c.endDate)), "object" == typeof c.minDate && (this.minDate = moment(c.minDate)), "object" == typeof c.maxDate && (this.maxDate = moment(c.maxDate)), "object" == typeof c.ranges) {
                for (var h in c.ranges) {
                    var i = moment(c.ranges[h][0]),
                            j = moment(c.ranges[h][1]);
                ...
                for (var h in this.ranges)
                    k += "<li>" + h + "</li>";
                k += "<li>" + this.locale.customRangeLabel + "</li>", k += "</ul>", this.container.find(".ranges").prepend(k)
            }
            if ("object" == typeof c.dateLimit && (this.dateLimit = c.dateLimit), "object" == typeof c.locale && "number" == typeof c.locale.firstDay) {
                ...
                for (var l = c.locale.firstDay; l > 0; )
                    this.locale.daysOfWeek.push(this.locale.daysOfWeek.shift()), l--
            }
        ...
        if (a.each(this.buttonClasses, function (a, b) {
            ...
            var n = this.container.find(".calendar.left"),
                    o = this.container.find(".calendar.right");
        ...
        if (("undefined" == typeof c || "undefined" == typeof c.ranges) && (this.container.find(".calendar").show(), this.move()), "function" == typeof d && (this.cb = d), this.container.addClass("opens" + this.opens), (!e || "undefined" == typeof c.startDate && "undefined" == typeof c.endDate) && a(this.element).is("input[type=text]")) {
            var i, j, p = a(this.element).val(),
                    q = p.split(this.separator);
    ...
    b.prototype = {
        ...
        hide: function () {
            this.container.hide(), this.startDate.isSame(this.oldStartDate) && this.endDate.isSame(this.oldEndDate) || this.notify(), this.oldStartDate = this.startDate.clone(), this.oldEndDate = this.endDate.clone(), a(document).off("mousedown", this.hide), this.element.trigger("hidden", {
                picker: this
            })
        },
        enterRange: function (a) {
            var b = a.target.innerHTML;
            if (b == this.locale.customRangeLabel)
                this.updateView();
            else {
                var c = this.ranges[b];
        ...
        clickDate: function (b) {
            var c = a(b.target).attr("data-title"),
                    ...
                    f = a(b.target).parents(".calendar");
            if (f.hasClass("left")) {
                var g = this.leftCalendar.calendar[d][e],
                        h = this.endDate;
                ...
                var g = this.startDate,
                        h = this.rightCalendar.calendar[d][e];
                if ("object" == typeof this.dateLimit) {
        ...
        updateMonthYear: function (b) {
            var c = a(b.target).closest(".calendar").hasClass("left"),
                    d = this.container.find(".calendar.left");
            c || (d = this.container.find(".calendar.right"));
            var e = parseInt(d.find(".monthselect").val()),
                    f = d.find(".yearselect").val();
        ...
        updateTime: function (b) {
            var c = a(b.target).closest(".calendar").hasClass("left"),
                    d = this.container.find(".calendar.left");
            c || (d = this.container.find(".calendar.right"));
            var e = parseInt(d.find(".hourselect").val()),
                    f = parseInt(d.find(".minuteselect").val());
        ...
        updateCalendars: function () {
            ...
            for (var c in this.ranges)
                this.timePicker ? this.startDate.isSame(this.ranges[c][0]) && this.endDate.isSame(this.ranges[c][1]) && (a = !1, this.container.find(".ranges li:eq(" + b + ")").addClass("active")) : this.startDate.format("YYYY-MM-DD") == this.ranges[c][0].format("YYYY-MM-DD") && this.endDate.format("YYYY-MM-DD") == this.ranges[c][1].format("YYYY-MM-DD") && (a = !1, this.container.find(".ranges li:eq(" + b + ")").addClass("active")), b++;
            a && this.container.find(".ranges li:last").addClass("active")
        },
        buildCalendar: function (a, b, c, d) {
            for (var f = moment([b, a, 1]), g = moment(f).subtract("month", 1).month(), h = moment(f).subtract("month", 1).year(), i = moment([h, g]).daysInMonth(), j = f.day(), k = [], l = 0; 6 > l; l++)
                k[l] = [];
            var m = i - j + this.locale.firstDay + 1;
            m > i && (m -= 7), j == this.locale.firstDay && (m = i - 6);
            for (var n = moment([h, g, m, c, d]), l = 0, o = 0, p = 0; 42 > l; l++, o++, n = moment(n).add("day", 1))
                l > 0 && 0 == o % 7 && (o = 0, p++), k[p][o] = n;
            return k
        },
        renderDropdowns: function (a, b, c) {
            for (var d = a.month(), e = '<select class="monthselect">', f = !1, g = !1, h = 0; 12 > h; h++)
                (!f || h >= b.month()) && (!g || h <= c.month()) && (e += "<option value='" + h + "'" + (h === d ? " selected='selected'" : "") + ">" + this.locale.monthNames[h] + "</option>");
            e += "</select>";
            for (var i = a.year(), j = c && c.year() || i + 5, k = b && b.year() || i - 50, l = '<select class="yearselect">', m = k; j >= m; m++)
                l += '<option value="' + m + '"' + (m === i ? ' selected="selected"' : "") + ">" + m + "</option>";
            return l += "</select>", e + l
        },
        renderCalendar: function (b, c, d, e) {
            ...
            if (f += "</tbody>", f += "</table>", f += "</div>", this.timePicker) {
                ...
                for (var o = l; m >= o; o++)
                    f += o == n ? '<option value="' + o + '" selected="selected">' + o + "</option>" : '<option value="' + o + '">' + o + "</option>";
