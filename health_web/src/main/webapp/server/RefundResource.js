...
dcomethealth.RefundResource = {
    baseURL: dcomethealth.ServerRequestResource.baseURL + "/refund/v1",
    saveRefund: function (data, arg, callback, errorCallback) {
    ...
    searchRefunds: function (data, callback, errorCallback) {
    ...
    searchRefundsReport: function (data, callback, errorCallback) {
        dcomethealth.ServerRequestResource.ajaxLoadingStart();
        return $
                .ajax({
                    type: "POST",
                    url: this.baseURL + "/searchRefunds",
                    data: JSON.stringify(data),
                    headers: {"Accept": "application/json", "Content-Type": "application/json; charset=utf-8"},
                    dataType: "html"
                }).done(function (data, textStatus, jqXHR) {
