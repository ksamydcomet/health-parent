...
dcomethealth.SalesResource = {
    baseURL: dcomethealth.ServerRequestResource.baseURL + "/sales/v1",
    saveSalesReturn: function (data, callback, errorCallback) {
        dcomethealth.ServerRequestResource.ajaxImageLoadingStart();
        return $
                .ajax({
                    type: "POST",
                    url: this.baseURL + "/salesreturn/save",
