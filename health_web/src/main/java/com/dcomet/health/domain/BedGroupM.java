...
public class BedGroupM extends Base implements Serializable {
    ...
    private List<BedMaster> bedMasterList;
    ...
    public List<BedMaster> getBedMasterList() {
        return bedMasterList;
    }

    public void setBedMasterList(List<BedMaster> bedMasterList) {
        this.bedMasterList = bedMasterList;
    }
