 ...
 * @author Dev1
 */
public class DrugRequestH extends Base implements Serializable {
    ...
    private String drugReqHActionCode;
    private Integer drugReqHVisitType;

    private List<DrugRequestD> drugRequestDList;
    ...
    public String getDrugReqHActionCode() {
        return drugReqHActionCode;
    }

    public void setDrugReqHActionCode(String drugReqHActionCode) {
        this.drugReqHActionCode = drugReqHActionCode;
    }

    public Integer getDrugReqHVisitType() {
        return drugReqHVisitType;
    }

    public void setDrugReqHVisitType(Integer drugReqHVisitType) {
        this.drugReqHVisitType = drugReqHVisitType;
    }

    public List<DrugRequestD> getDrugRequestDList() {
        return drugRequestDList;
    }

    public void setDrugRequestDList(List<DrugRequestD> drugRequestDList) {
        this.drugRequestDList = drugRequestDList;
    }
    ...
    public String toString() {
        ...
        sb.append("\n\tdrugReqHActionCode: String=");
        sb.append(drugReqHActionCode);
        sb.append(";");

        sb.append("\n\tdrugReqHVisitType: Integer=");
        sb.append(drugReqHVisitType);
        sb.append(";");
