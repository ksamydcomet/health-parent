 ...
 * @author Dev4
 */
public class ItemOrderSearchCriteria extends SearchCriteria {
    ...
    public Integer getIoItemQty() {
        return ioItemQty;
    }

    public void setIoItemQty(Integer ioItemQty) {
