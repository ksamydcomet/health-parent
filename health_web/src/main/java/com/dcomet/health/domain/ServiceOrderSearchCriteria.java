 ...
 * @author Dev3
 */
public class ServiceOrderSearchCriteria extends SearchCriteria {
    ...
    private Calendar soFromDate;
    private Calendar soToDate;
    ...
    private String soModifiedDatetime;
    ...
    public String getSoModifiedDatetime() {
        return soModifiedDatetime;
    }

    public void setSoModifiedDatetime(String soModifiedDatetime) {
        this.soModifiedDatetime = soModifiedDatetime;
    }
    ...
    public Calendar getSoFromDate() {
        return soFromDate;
    }

    public void setSoFromDate(Calendar soFromDate) {
        this.soFromDate = soFromDate;
    }

    public Calendar getSoToDate() {
        return soToDate;
    }

    public void setSoToDate(Calendar soToDate) {
    ...
    public String getSoStatusModDateTime() {
        return soStatusModifiedDateTime;
    }

    public void setSoStatusModDateTime(String soStatusModDateTime) {
        this.soStatusModifiedDateTime = soStatusModDateTime;
    }
    ...
    public Integer getSoProcessedBY() {
        return soProcessedBY;
    }

    public void setSoProcessedBY(Integer soProcessedBY) {
    ...
    public Integer getSoModifiedUserRID() {
        return soModifiedUserRID;
    }

    public void setSoModifiedUserRID(Integer soModifiedUserRID) {
        this.soModifiedUserRID = soModifiedUserRID;
    }
    ...
    public String toString() {
        ...
        sb.append("\n\tsoModifiedUserRID: Integer=");
        sb.append(soModifiedUserRID);
        sb.append(";");

        sb.append("\n\tsoModifiedDatetime: String=");
        sb.append(soModifiedDatetime);
        sb.append(";");
